...
public class BP {
	...
	public Map<String, double[][]> getWeight(){
		...
		map.put("iptHidWeights", this.iptHidWeights);
		map.put("hidOptWeights", this.hidOptWeights);
		map.put("iptHidPrevUptWeights", this.iptHidPrevUptWeights);
		map.put("hidOptPrevUptWeights", this.hidOptPrevUptWeights);
		return map;
	}
